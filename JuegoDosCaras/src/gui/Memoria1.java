 ...
 * @author Dark
 */
public class Memoria1 extends javax.swing.JFrame {
    ...
    private void setCards() {
        ...
        btnC1.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(1) + 1) + ".png")));
        btnC2.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(2) + 1) + ".png")));
        btnC3.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(3) + 1) + ".png")));
        btnC4.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(4) + 1) + ".png")));
        btnC5.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(5) + 1) + ".png")));
        btnC6.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(6) + 1) + ".png")));
        btnC7.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(7) + 1) + ".png")));
        btnC8.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/a" + (generados.get(0) + 1) + ".png")));
        btnC9.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(1) + 1) + ".png")));
        btnC10.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(2) + 1) + ".png")));
        btnC11.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(3) + 1) + ".png")));
        btnC12.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(4) + 1) + ".png")));
        btnC13.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(5) + 1) + ".png")));
        btnC14.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(6) + 1) + ".png")));
        btnC15.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(7) + 1) + ".png")));
        btnC16.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/b" + (generados2.get(0) + 1) + ".png")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Memoria1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
