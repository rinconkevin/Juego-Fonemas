 ...
 * @author Dark
 */
public class Memoria2 extends javax.swing.JFrame {
    ...
    private void setCards() {
        Stack< Integer> generados = new Stack< Integer>();
        Stack< Integer> generados2 = new Stack< Integer>();
        generados =  log.obtenerCartas();
        generados2 =  log.obtenerCartas();

        
        /* reemplazar el uso de "../imagenes/..." por "/imagenes/..." */
        btnC1.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + (generados.get(1)+1) + ".png")));
        btnC2.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + (generados.get(2)+1) + ".png")));
        btnC3.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + (generados.get(3)+1) + ".png")));
        btnC4.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + (generados.get(4)+1) + ".png")));
        btnC5.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + (generados.get(5)+1) + ".png")));
        btnC6.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + (generados.get(6)+1) + ".png")));
        btnC7.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" +(generados.get(7)+1) + ".png")));
        btnC8.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/c" + (generados.get(0)+1) + ".png")));
        btnC9.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(1)+1) + ".png")));
        btnC10.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(2)+1) + ".png")));
        btnC11.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(3)+1) + ".png")));
        btnC12.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(4)+1) + ".png")));
        btnC13.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(5)+1) + ".png")));
        btnC14.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(6)+1) + ".png")));
        btnC15.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(7)+1) + ".png")));
        btnC16.setDisabledIcon(new ImageIcon(getClass().getResource("/imagenes/d" + (generados2.get(0)+1) + ".png")));
        
        btnC1.setText((generados.get(1)+1) +"");
        btnC2.setText((generados.get(2)+1) +"");
        btnC3.setText((generados.get(3)+1) +"");
        btnC4.setText((generados.get(4)+1) +"");
        btnC5.setText((generados.get(5)+1) +"");
        btnC6.setText((generados.get(6)+1) +"");
        btnC7.setText((generados.get(7)+1) +"");
        btnC8.setText((generados.get(0)+1) +"");
        btnC9.setText((generados2.get(1)+1) +"");
        btnC10.setText((generados2.get(2)+1) +"");
        btnC11.setText((generados2.get(3)+1) +"");
        btnC12.setText((generados2.get(4)+1) +"");
        btnC13.setText((generados2.get(5)+1) +"");
        btnC14.setText((generados2.get(6)+1) +"");
        btnC15.setText((generados2.get(7)+1) +"");
        btnC16.setText((generados2.get(0)+1) +"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Memoria2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
